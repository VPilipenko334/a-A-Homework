...
def larger_than_russia
  # List each country name where the 
  #population is larger than 'Russia'.
  execute(<<-SQL)
...
def richer_than_england
  # Show the countries in Europe with
  # a per capita GDP greater than
  # 'United Kingdom'.
  execute(<<-SQL)
...
def neighbors_of_certain_b_countries
  # List the name and continent of 
  # countries in the continents containing
  # 'Belize', 'Belgium'.
  execute(<<-SQL)
...
def sparse_continents
  # Find every country that belongs to a 
  # continent where 
  ...
  # Hint: Sometimes rewording the problem can 
  # help you see the solution.

  #every country -- country name 
  execute(<<-SQL)
