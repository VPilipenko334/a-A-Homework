...
# When given a positive 'amt', a single rotation will rotate left, 
#causing the first element to move to the last index

# When given a negative 'amt', a single rotation will rotate right, 
#causing the last element to move to the first index
...
#mutate the arr by rotating the ele AMT of times 
#when positive - rotates left, first ele to move to last

#when negative, rotates right, last ele moves to first idex 
#return the given array 

#MUTATE 
#iterate through the array (use .shift/ .unshift )
